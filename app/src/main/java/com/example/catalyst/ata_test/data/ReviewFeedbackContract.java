 ...
 */
public class ReviewFeedbackContract {
    ...
    public static final class ReviewFeedbackEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "review_feedback";
